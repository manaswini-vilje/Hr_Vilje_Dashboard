...
export default function EmployeeDashboard() {
  ...
  const quickActions = [
    { title: 'Request Time Off', subtitle: 'Plan your holidays', icon: Calendar, color: 'blue' },
    { title: 'View Payslip', subtitle: 'Latest: Oct 2023', icon: FileText, color: 'green' },
    { title: 'Learning Hub', subtitle: '2 courses pending', icon: GraduationCap, color: 'purple' },
  ];
              ...
              <Card className="bg-blue-50 border-blue-100">
                ...
                <CardContent>
                  ...
                  <div className="flex gap-2">
                    <Button size="sm" className="flex-1 bg-white text-blue-700 hover:bg-blue-100 border border-blue-200">
                      Message
                    </Button>
